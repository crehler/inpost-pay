...
InPost Pay is a Shopware 6.5 plugin that integrates the InPost Pay payment platform with Shopware e-commerce. It enables multiple payment methods (BLIK, cards, Google Pay, Apple Pay, Pay by Link, deferred payments) and provides real-time basket synchronization with the InPost Pay mobile app.
