...
final class CartDesynchronizationSubscriberTest extends TestCase
{
    ...
    public function testOnCartDeletedSkipsDesyncWhenPrecededByCartMerge(): void
    {
        $sessionService = $this->createMock(InpostBasketSessionService::class);
        $sessionService->expects($this->never())->method('getSessionByBasketId');
        ...
        // Login cart merge fires first, then Shopware deletes the guest cart.
        $subscriber->onCartMerged($this->createMock(CartMergedEvent::class));
