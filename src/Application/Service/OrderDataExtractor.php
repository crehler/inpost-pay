...
readonly class OrderDataExtractor
{
    ...
    public function mapShopwareOrderToDomain(OrderEntity $shopwareOrder): Order
    {
        ...
        $statusDescription = $statusMapper->mapToPolish(
    ...
    private function extractOrderLines(OrderEntity $order, Context $context): array
    {
        ...
        foreach ($order->getLineItems() as $lineItem) {
            ...
            $unitGrossPrice = $price->getUnitPrice();
            $unitNetPrice = $unitGrossPrice - ($price->getCalculatedTaxes()->getAmount() / $lineItem->getQuantity());
            ...
            $lowestPrice = null;
            $regulation = $price->getRegulationPrice();
