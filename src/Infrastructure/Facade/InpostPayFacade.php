...
final readonly class InpostPayFacade implements InpostPayFacadeInterface
{
    ...
    /**
     * Usuwa powiązanie koszyka po stronie InPost i czyści powiązany lokalny stan sesji koszyka.
     *
     * Metoda wyszukuje sesję powiązaną z przekazanym identyfikatorem koszyka, pobiera z niej niezmienny
     * identyfikator koszyka rozpoznawany przez InPost i próbuje usunąć powiązanie w API InPost.
     * Niezależnie od powodzenia operacji zdalnej wykonuje lokalne czyszczenie stanu (usunięcie rozszerzenia
     * w koszyku, usunięcie sesji i dispatch zdarzenia desynchronizacji). Błędy przy usuwaniu po stronie InPost
     * są logowane jako ostrzeżenia i nie blokują lokalnego czyszczenia.
     *
     * @param string $basketId identyfikator koszyka używany do odnalezienia sesji (może to być token Shopware,
     *                         niekoniecznie ten sam, którego używa InPost)
     *
     * @throws BasketNotFoundException jeśli nie odnaleziono sesji dla podanego $basketId
     * @throws InvalidBasketException  jeśli podczas odczytu stanu koszyka wystąpił błąd walidacji
     * @throws DomainException         gdy wystąpi nieoczekiwany błąd podczas procesu desynchronizacji
     */
