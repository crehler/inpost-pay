...
final class InpostController extends AbstractController
{
    ...
    #[Route(
        ...
        defaults: [PlatformRequest::ATTRIBUTE_ROUTE_SCOPE => [StorefrontRouteScope::ID], 'auth_required' => false],
        methods: ['POST'],
    )]
    ...
    #[Route(
        ...
        defaults: [PlatformRequest::ATTRIBUTE_ROUTE_SCOPE => [ApiRouteScope::ID], 'auth_required' => false],
        methods: ['POST'],
    )]
    #[Route(
