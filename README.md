# InPost Pay - Wtyczka dla Shopware 6.7
...
### Wymagania platformy:
- **Shopware**: wersja **6.7.x** (co najmniej **6.7.7**)
- **PHP**: wersja **8.2**, **8.3**, **8.4** lub **8.5**
